...
import com.blackcoffee.work.presenter.PresenterOverTime;
 ...
 * 加班的activity
 */
public class OverTimeActivity extends BaseActivity<IOverTimeView, PresenterOverTime> implements
        IOverTimeView,
    ...
    private PresenterOverTime presenterOverTime;
    ...
    @Override
    protected PresenterOverTime creatPresenter() {
        if (null == presenterOverTime) {
            presenterOverTime = new PresenterOverTime(this);
        }
        return presenterOverTime;
    }
    ...
    protected void initViews() {
        ...
        tv_common_title.setText(R.string.over_time);
        ...
        AndPermission
                ...
                .rationale(new RationaleListener() {
                    ...
                    public void showRequestPermissionRationale(int requestCode, final Rationale rationale) {
                        AndPermission.rationaleDialog(OverTimeActivity.this, rationale).show();
                    }
                })
                .callback(this)
                .start();
    ...
    public void doIsAddFile() {
        ...
        presenterOverTime.doPermissionCheck(
    ...
    public void onChildClick(String adapterTag, View view, Object o) {
        presenterOverTime.doDealItemChildClick(adapterTag, o);
    }
    ...
    public void onFailed(int requestCode, @NonNull List<String> deniedPermissions) {
        switch (requestCode) {
            ...
            case ConstIntent.RequestCode.APPLY_FOR_PERMISSION_UPLOAD:
                presenterOverTime.doShowPermissionDialog();
                break;
        }
    }
}
