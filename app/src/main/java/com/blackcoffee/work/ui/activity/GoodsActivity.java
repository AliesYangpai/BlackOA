...
import com.blackcoffee.work.presenter.PresenterGoods;
...
public class GoodsActivity extends BaseActivity<IGoodsView, PresenterGoods> implements
        IGoodsView,
    ...
    private EditText et_goods_purpose;
    ...
    @Override
    protected PresenterGoods creatPresenter() {
        if (null == presenterGoods) {

            presenterGoods = new PresenterGoods(this);
        }

        return presenterGoods;
    }
    ...
    protected void initViews() {
        ...
        tv_common_title.setText(R.string.goods_apply);


        et_goods_purpose = findOAViewById(R.id.et_goods_purpose);
        et_goods_name = findOAViewById(R.id.et_goods_name);
    ...
    public void doIsAddFile() {
        ...
        presenterGoods.doPermissionCheck(
    ...
    public void onChildClick(String adapterTag, View view, Object o) {
        presenterGoods.doDealItemChildClick(adapterTag, o);
    }
    ...
    public void onFailed(int requestCode, @NonNull List<String> deniedPermissions) {
        switch (requestCode) {
            ...
            case ConstIntent.RequestCode.APPLY_FOR_PERMISSION_UPLOAD:
                presenterGoods.doShowPermissionDialog();
                break;
        }
    }
}
