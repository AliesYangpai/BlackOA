...
import com.blackcoffee.work.androidelement.receiver.NetWorkBroadCastReciver;
import com.blackcoffee.work.callback.NetWorkStateChangedCallBack;
import com.blackcoffee.work.presenter.BasePresenter;
import com.blackcoffee.work.ui.widget.AdhDialog;
...
//                android.R.color.holo_green_light};
        ...
        return new int[]{Color.parseColor("#ff33b5e5"),
...
//                ToastUtil.showMsg(getApplicationContext(), R.string.wifi_connect);
            }

            @Override
            public void onNetChangeToMobel() {
//                ToastUtil.showMsg(getApplicationContext(),R.string.mobel_connect);
            }
            ...
            public void onNetChangeNoConnect() {
                ...
                ToastUtil.showMsg(getApplicationContext(), R.string.no_net_connect);
