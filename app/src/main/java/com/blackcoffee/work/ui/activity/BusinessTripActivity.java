...
import com.blackcoffee.work.presenter.PresenterBusinessTrip;
...
public class BusinessTripActivity extends BaseActivity<IBusinessTripView,PresenterBusinessTrip> implements
        IBusinessTripView,
    ...
    private PresenterBusinessTrip presenterBusinessTrip;
    ...
    @Override
    protected PresenterBusinessTrip creatPresenter() {

        if(null == presenterBusinessTrip) {

            presenterBusinessTrip = new PresenterBusinessTrip(this);
        }

        return presenterBusinessTrip;
    }
    ...
    protected void initViews() {
        ...
        tv_common_title.setText(R.string.business_trip);
        ...
        rl_place = findOAViewById(R.id.rl_place);
        tv_place = findOAViewById(R.id.tv_place);
        rl_start_time = findOAViewById(R.id.rl_start_time);
        tv_start_time = findOAViewById(R.id.tv_start_time);
        rl_end_time = findOAViewById(R.id.rl_end_time);
        tv_end_time = findOAViewById(R.id.tv_end_time);
        ...
        AndPermission
                ...
                .rationale(new RationaleListener() {
                    ...
                    public void showRequestPermissionRationale(int requestCode, final Rationale rationale) {
                        AndPermission.rationaleDialog(BusinessTripActivity.this, rationale).show();
                    }
                })
                .callback(this)
                .start();
    ...
    public void doIsAddFile() {
        ...
        presenterBusinessTrip.doPermissionCheck(
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_common_back:
                ...
                break;
            case R.id.rl_place:
                ToastUtil.showMsg(getApplicationContext(), "选择城市");
                break;
    ...
    public void onChildClick(String adapterTag, View view, Object o) {
        presenterBusinessTrip.doDealItemChildClick(adapterTag, o);
    }
    ...
    public void onFailed(int requestCode, @NonNull List<String> deniedPermissions) {
        switch (requestCode) {
            ...
            case ConstIntent.RequestCode.APPLY_FOR_PERMISSION_UPLOAD:
                presenterBusinessTrip.doShowPermissionDialog();
                break;
        }
    }
}
