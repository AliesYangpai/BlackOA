...
import com.blackcoffee.work.presenter.PresenterTakeBreak;
 ...
 * 请假的activity
 */
public class TakeBreakActivity extends BaseActivity<ITakeBreakView, PresenterTakeBreak> implements
        ITakeBreakView,
    ...
    private PresenterTakeBreak presenterTakeBreak;
    ...
    private RelativeLayout rl_take_break_type;
    private TextView tv_take_break_type;
    private RelativeLayout rl_take_break_start_time;
    private TextView tv_take_break_start_time;
    private RelativeLayout rl_take_break_end_time;
    private TextView tv_take_break_end_time;
    private TextView tv_break_period;


    private EditText et_take_break_reason;
    ...
    @Override
    protected PresenterTakeBreak creatPresenter() {
        if (null == presenterTakeBreak) {
            presenterTakeBreak = new PresenterTakeBreak(this);
        }

        return presenterTakeBreak;
    }
    ...
    protected void initViews() {
        ...
        tv_common_title.setText(R.string.take_break);


        et_take_break_reason = findOAViewById(R.id.et_take_break_reason);


        rl_take_break_type = findOAViewById(R.id.rl_take_break_type);
        tv_take_break_type = findOAViewById(R.id.tv_take_break_type);
        rl_take_break_start_time = findOAViewById(R.id.rl_take_break_start_time);
        tv_take_break_start_time = findOAViewById(R.id.tv_take_break_start_time);
        rl_take_break_end_time = findOAViewById(R.id.rl_take_break_end_time);
        tv_take_break_end_time = findOAViewById(R.id.tv_take_break_end_time);

        tv_break_period = findOAViewById(R.id.tv_break_period);
    ...
    protected void initListener() {
        ...
        rl_take_break_type.setOnClickListener(this);
        rl_take_break_start_time.setOnClickListener(this);
        rl_take_break_end_time.setOnClickListener(this);
        ...
        AndPermission
                ...
                .rationale(new RationaleListener() {
                    ...
                    public void showRequestPermissionRationale(int requestCode, final Rationale rationale) {
                        AndPermission.rationaleDialog(TakeBreakActivity.this, rationale).show();
                    }
                })
                .callback(this)
                .start();
    ...
    public void doIsAddFile() {
        ...
        presenterTakeBreak.doPermissionCheck(
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_common_back:
                dofinishItself();
                break;
            case R.id.rl_take_break_type:
                ToastUtil.showMsg(getApplicationContext(), "请假类型");
                break;
            case R.id.rl_take_break_start_time:
                ToastUtil.showMsg(getApplicationContext(), "开始时间");
                break;
            case R.id.rl_take_break_end_time:
    ...
    public void onChildClick(String adapterTag, View view, Object o) {
        presenterTakeBreak.doDealItemChildClick(adapterTag, o);
    }
    ...
    public void onFailed(int requestCode, @NonNull List<String> deniedPermissions) {
        switch (requestCode) {
            ...
            case ConstIntent.RequestCode.APPLY_FOR_PERMISSION_UPLOAD:
                presenterTakeBreak.doShowPermissionDialog();
                break;
        }
    }
}
