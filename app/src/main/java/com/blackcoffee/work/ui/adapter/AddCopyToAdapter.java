 ...
 * 版本
 */
public class AddCopyToAdapter extends BaseSelfAdapter<ItemDynamicOperateSelfHolder> {


    public static final String Tag = AddCopyToAdapter.class.getSimpleName();
