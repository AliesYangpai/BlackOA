 ...
 */
public class ContactPhonesAdapter extends IndexableAdapter<SelfContact> {
    private LayoutInflater mInflater;
    private Bitmap bitmap;
    private FunctionText functionText;

    public ContactPhonesAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateContentViewHolder(ViewGroup parent) {
        View view = mInflater.inflate(R.layout.item_contact_phone, parent, false);
        return new ContentContactsPhoneVH(view);
    }
    ...
    public void onBindContentViewHolder(RecyclerView.ViewHolder holder, SelfContact selfContact) {
        ContentContactsPhoneVH vh = (ContentContactsPhoneVH) holder;
