 ...
 * 版本
 */
public class AddApproverAdapter extends BaseSelfAdapter<ItemDynamicOperateSelfHolder> {


    public static final String Tag = AddApproverAdapter.class.getSimpleName();
