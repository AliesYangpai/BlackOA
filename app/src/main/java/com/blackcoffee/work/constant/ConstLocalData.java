...
public class ConstLocalData {
    ...
    public static final int DEFUALT_APP_SINGLE_COUNT = 4;//应用界面中 默认的每行 应用数量
    public static final int DEFUALT_DYNAMIC_OPERATE_SINGLE_COUNT = 4;//动态列表不布局操作的单行数量
     ...
     * 动态adapter布局
     */
    public static final int ADATER_APPROVE = 1;  //审批
    public static final int ADATER_REPORT= 2;  //汇报
    public static final int ADATER_CLIENT = 3;  //客户
    public static final int ADATER_ANNOUNCE = 4;  //公告
     ...
     * tabLayout相关
     */
    public static final int TAB_INDEX_0 = 0; // tablayout的索引 全部
    public static final int TAB_INDEX_1 = 1; //tablayout的索引 审批
    public static final int TAB_INDEX_2 = 2;//tablayout的索引 汇报
    public static final int TAB_INDEX_3 = 3;//tablayout的索引 客户
    public static final int TAB_INDEX_4 = 4;//tablayout的索引 公告


    /**
     * 图片圆角处理
     */
    public static final int IMG_RADIUS_5 = 5;
